...
(orangecontrib.statistic.widgets). The packages __init__.py contains category metadata,
...
all widgets). This statistic add-on includes three different locations:
